...
// Reprograme esta funcion para que se ignore las diferencias entre
// mayusculas y minusculas
    char c1;
    char c2;

    for (;;) {
      c1= *s1; // Si c1 es mayuscula, conviertalo a minuscula
      c2= *s2; // Si c2 es mayuscula, conviertalo a minuscula
